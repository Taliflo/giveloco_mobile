...
/*    TLFRegisterViewController * registerVC = [[TLFRegisterViewController alloc] init];
    ...
    self.window.backgroundColor = [CustomColor lightestGrey];
...
- (void)startApplication
{
    ...
    self.myAccountVC = [[MyAccountViewController alloc] init];
    ...
    self.causesVC = [[CausesViewController alloc] init];
    ...
    self.businessesVC = [[BusinessesViewController alloc] init];
    ...
    [self.tabBarController.tabBar setBarTintColor:[CustomColor lightestGrey]];
    [self.tabBarController.tabBar setTintColor:[CustomColor talifloTiffanyBlue]];
    
    // Set the navigation bar style
    [[UINavigationBar appearance] setBarTintColor:[UIColor whiteColor]];
    [[UINavigationBar appearance] setTintColor:[CustomColor talifloTiffanyBlue]];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "AMA.CoreData" in the application's documents directory.
